...
//User 클래스는 스프링 시큐리티에 내장된 추상 클래스로 사용자 상세정보를 담는 그릇 역할을 하는 클래스
//User 클래스는 추상클래스이므로 추상메소드를 오버라이드 해서 구현한다
public class UserVO extends User{

	private String userid;
	
	//두 생성자 중 첫 번째 선택, 마지막 매개변수에 String userid 추가
	//super는 부모 User 클래스
